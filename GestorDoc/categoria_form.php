...
<form name="CATEGORIA" method="POST"  style="margin:0px">
  <input name="categoria" value="<ingrese descripcion>" type="text" maxlength=80 style="position:absolute;width:200px;left:133px;top:97px;z-index:2">
  <textarea name="obs" style="position:absolute;left:134px;top:137px;width:379px;height:97px;z-index:3"><ingrese sus notas y comentarios ></textarea>
